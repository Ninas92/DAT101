...
export class TMenu {
  ...
  constructor(aSpriteCanvas) {
    ...
    GameProps.status = EGameStatus.idle; //Bruk denne til å "jukse" med spillstatusen
    ...
    this.#posScore = new lib2d.TPosition(389, 181);
    this.#posBestScore = new lib2d.TPosition(389, 225);

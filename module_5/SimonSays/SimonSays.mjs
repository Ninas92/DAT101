...
export const gameProps = {
  ...
  ColorButtons: [new TColorButton(spcvs, SpriteInfoList.ButtonYellow), new TColorButton(spcvs, SpriteInfoList.ButtonBlue), new TColorButton(spcvs, SpriteInfoList.ButtonRed), new TColorButton(spcvs, SpriteInfoList.ButtonGreen)],
  sequence: [],
...
function drawGame() {
  ...
  //Annen metode: gameProps.ColorButtons.forEach(button) => button.draw());

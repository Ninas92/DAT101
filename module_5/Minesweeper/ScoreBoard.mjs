...
export class TScoreBoard {
  ...
  constructor(aSpriteCanvas) {
    ...
    this.spSmiley.onSmileyMouseDown = this.onSmileyMouseDown; //Dette må være pilfunksjon
    this.spSmiley.onMouseUp = this.onSmileyMouseUp; //Dette må være en pil-funksjon
  ...
  stopTime() {
    clearInterval(this.#hndTime); //For å stoppe Timeren, f.eks v/ GameOver
  }
